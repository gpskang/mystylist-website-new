...
export default function Customers() {
  ...
  return (
    <section id="customers" className=" bg-[#f1f9fc] !py-12 sm:!py-16">
        ...
        <div className="mt-8  grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 lg:!gap-6 !gap-4">
          {videos.map((video) => (
            ...
            >
              ...
              <div className="absolute z-2 flex flex-col items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition">
