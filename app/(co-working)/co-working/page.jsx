...
import BookingCard from "@/components/coworking/BookingCard";
import AboutConcept from "@/components/coworking/AboutSection"
import CustomersSection from "@/components/coworking/Customers"
import ContactUs from "@/components/coworking/ContactUs"
import AboutUs from "@/components/coworking/AboutUs"
export default function Page() {
  return (
    <main className="min-h-screen flex flex-col bg-white">

      {/* Hero */}
      <section className="relative min-h-[600px] flex items-center justify-center  isolate overflow-hidden ">
